...
namespace System
{
    public class Scene : MonoBehaviour
    {
        ...
        protected void Build()
        {
            ...
            _partitions = Instantiate(UnityEngine.Resources.Load(Globals.ResourcesPaths.Partitions)) as GameObject;
            _partitions.name = Globals.SceneGameObjects.Partitions;
            _playerLanes = Instantiate(UnityEngine.Resources.Load(Globals.ResourcesPaths.Lanes)) as GameObject;
            _playerLanes.name = Globals.SceneGameObjects.Lanes;
            OppositeLanes = Instantiate(UnityEngine.Resources.Load(Globals.ResourcesPaths.OppositeLanes)) as GameObject;
            if (OppositeLanes != null) OppositeLanes.name = Globals.SceneGameObjects.OppositeLanes;
            _playerGameObject = Instantiate(UnityEngine.Resources.Load(Globals.ResourcesPaths.Car)) as GameObject;
            if (_playerGameObject != null)
            {
                _playerGameObject.AddComponent<Player.Player>();
